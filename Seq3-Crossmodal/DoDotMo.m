function DoDotMo(Cfg, directions, dotSpeed, duration)
...
while continue_show && GetSecs<=movieStartTime+duration
    ...
    %%      
        ...
        Screen('DrawLines', w, Cfg.allCoords,Cfg.lineWidthPix, [255 255 255].*B(continue_show) , [Cfg.center(1) Cfg.center(2)], 1);  % Draw the fixation cross
